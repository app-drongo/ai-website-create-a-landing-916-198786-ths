...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Explore Our Methodology
  };

  const handleSecondaryAction = () => {
    setIsModalOpen(true); // Watch SAP Implementation Demo
  };
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary">
              ...
              Since 2015: 500+ Successful Implementations
            </div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              SAP Integrator Company delivers enterprise-grade ERP implementations with 99.8%
              success rate across 35+ countries. Transforming Business Through SAP ERP Excellence.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              >
                <Play className="mr-2 size-5" /> Watch SAP Demo
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="SAP ERP Dashboard Implementation"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Implementation Speed</p>
              <p className="text-sm">
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">99.8%</span> Projects
              </p>
            </div>
          </div>
        </div>
